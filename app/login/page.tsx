  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      ...
      <div className="glass-card p-8 text-center max-w-sm w-full">
        ...
        <h1 className="gradient-text text-2xl font-bold tracking-tight mb-2">
          SPRINT PLANNER
        </h1>
        ...
        {error === 'AccessDenied' && (
          <div className="mb-6 p-3 rounded-lg bg-destructive/10 border border-destructive/30">
            <p className="text-xs text-destructive">
              Access restricted to @tubescience.com accounts.
            </p>
          </div>
        )}
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg bg-white text-gray-800 font-medium border border-gray-200 hover:bg-gray-50 transition-colors"
        >
        ...
        <p className="text-xs text-muted-foreground mt-6">
          Restricted to TubeScience accounts
        </p>
      </div>
    </div>
  );
